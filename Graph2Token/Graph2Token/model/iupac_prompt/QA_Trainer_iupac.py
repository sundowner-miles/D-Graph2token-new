...
from model.iupac_prompt.QA_llama3_iupac import Align2llama
...
class QA_Trainer(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        # OPT
        parser.add_argument('--opt_model', type=str, default="/LLM/LLama3-chat")
        parser.add_argument('--num_beams', type=int, default=5)
        parser.add_argument('--llm_tune', action='store_true', default=False)

        # optimization
        parser.add_argument('--weight_decay', type=float, default=0.05, help='optimizer weight decay')
        parser.add_argument('--init_lr', type=float, default=1.67e-4, help='optimizer init learning rate')
        ...
        # parser.add_argument('--stage2_path', type=str, default='your stage 2 saved checkpoints')
