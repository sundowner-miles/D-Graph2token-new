...
class Align2llama(nn.Module):
    ...
    def __init__(
        ...
        # 优化点：如果 args 中开启了 enable_flash，则使用 flash_attention_2 优化显存
        attn_implementation = "flash_attention_2" if (args and getattr(args, 'enable_flash', False)) else "eager"
        
        self.llm_model = LlamaForSequenceClassification.from_pretrained(
            llm_model, 
    ...
    def forward(self, batch):
        ...
        loss_cls = loss_fct(logits.view(-1, 2), text_values.view(-1))
